                                        ...
                                        <a class="social-btn text-white sb-light sb-{{$item->name}} me-2 mb-2 d-flex justify-content-center align-items-center"
                                           target="_blank" href="{{$item->link}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16" viewBox="0 0 50 50">
                                                <path fill="#25F4EE" d="M41,16.3c-4.4,0-8.3-2.3-10.5-5.8v19.5c0,6.3-5.1,11.5-11.5,11.5S7.5,36.3,7.5,30S12.6,18.5,19,18.5 c0.4,0,0.8,0,1.2,0.1v5.3c-0.4-0.1-0.8-0.2-1.2-0.2c-3.4,0-6.2,2.8-6.2,6.3s2.8,6.3,6.2,6.3s6.2-2.8,6.2-6.3V5h6 c1.1,6,6.3,10.5,12.5,10.5V16.3z"></path>
                                                <path fill="#FE2C55" d="M19,41.3c-6.3,0-11.5-5.1-11.5-11.5s5.1-11.5,11.5-11.5c0.4,0,0.8,0,1.2,0.1v5.3c-0.4-0.1-0.8-0.2-1.2-0.2 c-3.4,0-6.2,2.8-6.2,6.3s2.8,6.3,6.2,6.3s6.2-2.8,6.2-6.3V10h5.3c1,5.9,6.1,10.3,12.2,10.5v5.3C37.8,25.5,32.6,21,31.5,15h-2.7v19.5 C28.8,36.2,24.1,41.3,19,41.3z"></path>
                                                <path fill="#25F4EE" d="M19,29.3c-0.4,0-0.8-0.1-1.2-0.2c-2.5-0.5-4.3-2.8-4.3-5.3c0-2.5,1.8-4.8,4.3-5.3c0.4-0.1,0.8-0.1,1.2-0.1v2.5 c-0.4-0.1-0.8-0.1-1.2-0.1c-1.7,0-3,1.4-3,3s1.4,3,3,3c0.4,0,0.8-0.1,1.2-0.2V29.3z"></path>
                                                <path fill="#FE2C55" d="M41,16.3c-4.4,0-8.3-2.3-10.5-5.8v19.5c0,6.3-5.1,11.5-11.5,11.5S7.5,36.3,7.5,30S12.6,18.5,19,18.5 c0.4,0,0.8,0,1.2,0.1v5.3c-0.4-0.1-0.8-0.2-1.2-0.2c-3.4,0-6.2,2.8-6.2,6.3s2.8,6.3,6.2,6.3s6.2-2.8,6.2-6.3V5h6 c1.1,6,6.3,10.5,12.5,10.5V16.3z"></path>
                                            </svg>
                                        </a>
                                    @else
